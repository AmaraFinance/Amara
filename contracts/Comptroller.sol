...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function seizeAllowed(
        ...
        distributeSupplierComp(aTokenCollateral, borrower);
        distributeSupplierComp(aTokenCollateral, liquidator);
     ...
     * @param holder The address to claim COMP for
     * @param aTokens The list of markets to claim COMP in
     */
    ...
    /**
     * @notice Transfer AMARA to the user
    ...
    /**
     * @notice Transfer AMARA to the recipient
     * @dev Note: If there is not enough COMP, we do not perform the transfer all.
    ...
    /**
     * @notice Set AMARA speed for a single market
     * @param aToken The market whose AMARA speed to update
     * @param compSpeed New AMARA speed for market
     */
    ...
    /**
     * @notice Set AMARA speed for a single contributor
     * @param contributor The contributor whose AMARA speed to update
     * @param compSpeed New AMARA speed for contributor
     */
    function _setContributorCompSpeed(address contributor, uint compSpeed) public {
        require(adminOrInitializing(), "only admin can set comp speed");

        // note that AMARA speed could be set to 0 to halt liquidity rewards for a contributor
